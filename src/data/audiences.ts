...
export const AUDIENCES: Audience[] = [
  {
    ...
    points: [
      ...
      'Google and Outlook calendars plug straight in, so work meetings, birthdays and school holidays all sit side by side.',
  ...
  },
  {
    ...
    points: [
      ...
      'Spend stars in a shop the grown-ups set: extra screen time, choose dinner, or pick something from your wishlist.',
      'Tuck stars into a star investment and collect a little bonus when it grows.',
      'A streak bonus for keeping the routine going, morning after morning.',

...
| **RevenueCat** (RevenueCat, Inc.) | Verifies and manages the one-time purchase so it unlocks Hubbly for your household. | An anonymous app identifier and purchase information from your app store (product, price, currency, date). Never your card details. |
...
<Callout type="plain">
We work with a handful of trusted suppliers, mainly Google's Firebase for sync, plus Open-Meteo for weather, Sentry and PostHog for diagnostics, RevenueCat for the one-time purchase, and the Google or Microsoft calendar APIs if you connect a calendar. We never sell your data and there are no advertisers in the picture.
</Callout>
...
- **If your free trial ends and you decide not to buy**: your synced family data is kept for **30 days** after the trial ends so you can pick up where you left off, and is then **permanently deleted**, along with the family's anonymous accounts. The app shows you this clearly, and you can choose to delete everything immediately instead.
- **Connected calendars**: a calendar you connect stays connected, and its events refresh, until you remove it. Removing a connected calendar in Settings stops the sync and deletes that calendar's events from Hubbly. You can also withdraw Hubbly's access from your Google or Microsoft account's security settings at any time.
